<?php
namespace ProtectedNet\FrontendTest\Components\Statistic;
...
class Statistic extends AbstractComponent
{
  ...
  public function setPercent(string $percent)
  {
    ...
    $this->_percentVal = 339.292 * ((100 - $percent) / 100);
    return $this;
  }
  ...
  public function getPercentVal(): string
  {
    return $this->_percentVal;
  }
